		...
		<address className="[ card-office ] [ stack ]">
			...
			<div className="card-office__content">
				<div className="fg-neutral-5">
					<p className="desc-1">Mail : <a href={`mailto:${props.email}`}>{props.email}</a></p>
					<p className="desc-1">Address : {props.address}</p>
					<p className="desc-1">Phone : <a href={`tel:${props.phone}`}>{props.phone}</a></p>
				</div>
